...
public class ProbabilityToEat {
    private static final int[][] Probability = new int[][]{
    ...
    public static boolean eatingOpportunity(Animal animal, Animal animal2) {
        int probability = Probability[animal.id][animal2.id];
